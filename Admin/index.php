            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php 
                        ...
                        $sql2="SELECT count(*) as jumlah FROM user WHERE role='User'";
                        $result2 = mysqli_query($conn, $sql2);
                        $row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC);
                        $jumlahPelajar = $row2['jumlah'] ?? 0;
               
                        $sql="SELECT count(*) as jumlah FROM file WHERE user_id=$uid";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
                        $jumlahAcademicAdvisor = $row['jumlah'] ?? 0;
                                            ...
                                            <div class="row row-cols-xxl-2 row-cols-md-2 row-cols-1 g-0">
                                                ...
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total User</h5>
                                                ...
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total Your Note</h5>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <i class="bx bx-note  display-6 text-muted"></i>
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <h2 class="mb-0"><span class="counter-value" data-target="<?php echo $jumlahAcademicAdvisor; ?>">0</span></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
